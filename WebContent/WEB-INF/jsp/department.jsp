					...
					<h1 class="page-header">
						...
						<div style="float: right">
							<button id="new" type="button" class="btn btn-primary"
								style="align: right"
								onclick="location='${pageContext.request.contextPath }/department/new'">New
								Department</button>
						</div>
					</h1>
				</div>
							...
							<div class="dataTable_wrapper">
								<table class="table table-striped table-bordered table-hover"
									...
									<tbody>
										...
										<c:forEach var="c" items="${requestScope.departments}">
											<tr class="odd gradeX">
												<td align="center">${c.departmentId}</td>
												<td align="center">${c.departmentName}</td>
												<td align="center">${c.description}</td>
												<td align="center">
													<button type="button" class="btn btn-success"
														style="width: 80px"
														onclick="location='${pageContext.request.contextPath}/department/modify?departmentId=${c.departmentId}&departmentName=${c.departmentName}&description=${c.description}'">Modify</button>
													<button class="btn btn-warning" style="width: 80px"
														onclick="confirmation(${c.departmentId},this);">Delete</button>
													<button type="button" id="confirm_${c.departmentId}"
														class="btn btn-danger" style="display: none; width: 80px"
														onclick="location='${pageContext.request.contextPath}/department/delete?departmentId=${c.departmentId}'">Confirm</button>
												</td>
											</tr>
										</c:forEach>

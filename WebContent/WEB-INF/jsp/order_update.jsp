					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form role="form" method="POST"
								action="${pageContext.request.contextPath}/order/update">
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<label style="color: red">Order ID</label> <input
								...
								<div class="row">
									<div class="col-lg-6">
										...
										<div class="form-group">
											<label>Order Status(*)</label> <input name="orderStatus"
												class="form-control" value="${order.getOrderStatus()}"
												required>
										</div>

										<div class="form-group">
											<label>Order Date</label> <input name="orderDate"
												class="form-control" value="${order.getOrderDate()}" readonly>
										</div>
									...
									<div class="col-lg-6">
										<div class="form-group">
											<label>Customer ID</label> <input class="form-control"
												name="userId" value="${order.getUserId()}" readonly>
										</div>
										
										<div class="form-group">
											<label>Order Sum</label> <input class="form-control"
												name="orderSum" value="${order.getOrderSum()}" readonly>
										</div>

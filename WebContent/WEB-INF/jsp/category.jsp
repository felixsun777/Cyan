					...
					<h1 class="page-header">
						...
						<div style="float: right">
							<button id="new" type="button" class="btn btn-primary"
								style="align: right"
								onclick="location='${pageContext.request.contextPath }/category/new'">New
								Category</button>
						</div>
					</h1>
				</div>
											...
											<tr class="odd gradeX">
												...
												<td align="center">
													<button type="button" class="btn btn-success"
														style="width: 80px"
														onclick="location='${pageContext.request.contextPath}/category/modify?categoryId=${c.categoryId}&categoryName=${c.categoryName}&departmentId=${c.departmentId}&description=${c.description}'">Modify</button>
													<button class="btn btn-warning" style="width: 80px"
														onclick="confirmation(${c.categoryId},this);">Delete</button>
													<button type="button" class="btn btn-danger"
														id="confirm_${c.categoryId}"
														style="display: none; width: 80px"
														onclick="location='${pageContext.request.contextPath}/category/delete?categoryId=${c.categoryId}'">Confirm</button>
												</td>
											</tr>
										</c:forEach>

					...
					<h1 class="page-header">
						...
						<div style="float: right">
							<button id="new" type="button" class="btn btn-danger"
								...
								onclick="location='${pageContext.request.contextPath }/customer/customers'">Return</button>
						</div>
					</h1>
				</div>
				<!-- /.col-lg-12 -->
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<label style="color: red">User ID</label> <input
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											<label>Username(*)</label> <input name="username"
												class="form-control" value="${customer.getUsername()}"
												required>
										</div>

										<div class="form-group">
											<label>Real Name</label> <input name="realName"
												class="form-control" value="${customer.getRealName()}">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label>Address</label> <input name="address"
												class="form-control" value="${customer.getAddress()}">
										</div>
										<div class="form-group">
											<label></label>
										</div>
									...
									<div class="col-lg-6">
										<div class="form-group">
											<label for="password">Password(*)</label> <input
												...
												name="password" value="${customer.getPassword()}" required data-eye>
										</div>

										<div class="form-group">
											<label>Receive Email</label> <input name="receiveEmail"
												class="form-control" value="${customer.getReceiveEmail()}" ${customer.getReceiveEmail() ? 'checked' : ''}>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label>Zip Code</label> <input name="zip"
												class="form-control" value="${customer.getZip()}">
										</div>
										<div class="form-group">
											<label></label>
										</div>

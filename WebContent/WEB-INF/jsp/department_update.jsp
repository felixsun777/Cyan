					...
					<h1 class="page-header">
						...
						<div style="float: right">
							<button id="new" type="button" class="btn btn-danger"
								...
								onclick="location='${pageContext.request.contextPath }/department/departments'">Return</button>
						</div>
					</h1>
				</div>
				<!-- /.col-lg-12 -->
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form role="form" method="POST"
								action="${pageContext.request.contextPath}/department/update">
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<label style="color: red">Department ID</label> <input
												name="departmentId" class="form-control"
												value="${department.getDepartmentId()}" readonly>
										</div>
									</div>
